...
import core.application.session.domain.exception.AttendanceStartTimeDateMismatchException
import core.application.session.domain.exception.InvalidAttendanceCodeException
import core.application.session.domain.exception.TooEarlyAttendanceException
